...
public class XYBarChartTests extends TestCase {
	...
	public void testCreateXYBarChart_NullOrientation() {
		try {
			ChartFactory.createXYBarChart("XY Bar Chart", // chart title
					"Domain", false, "Range", null, // data
	...
	public void testCreateXYBarChart_DateAxisEnabled() {
		JFreeChart chart = createChart_DateAxisEnabled();
	...
	private static JFreeChart createChart() {
		...
		// create the chart...
		return ChartFactory.createXYBarChart("XY Bar Chart", // chart title
				"Domain", false, "Range", dataset, // data
	...
	private static JFreeChart createChart_DateAxisEnabled() {
		...
		// create the chart...
		return ChartFactory.createXYBarChart("XY Bar Chart", // chart title
				"Domain", true, "Range", dataset, // data
