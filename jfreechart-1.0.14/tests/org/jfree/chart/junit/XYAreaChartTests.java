...
public class XYAreaChartTests extends TestCase {
	...
	public void testCreateXYAreaChart_NullOrientation() {
		try {
			ChartFactory.createXYAreaChart("Area Chart", // chart title
	...
	public void testCreateXYAreaChart_VerticalMinimalOptions() {
		JFreeChart chart = createChart_HorizontalMinimalOptions();
	...
	private static JFreeChart createChart() {
		...
		// create the chart...
		return ChartFactory.createXYAreaChart("Area Chart", // chart title
	...
	private static JFreeChart createChart_HorizontalMinimalOptions() {
