...
public class XYLineChartTests extends TestCase {
	...
	public void testCreateXYLineChart_NullOrientation() {
		try {
			ChartFactory.createXYLineChart("XY Line Chart", // chart title
	...
	private static JFreeChart createChart() {
		...
		// create the chart...
		return ChartFactory.createXYLineChart("XY Line Chart", // chart title
