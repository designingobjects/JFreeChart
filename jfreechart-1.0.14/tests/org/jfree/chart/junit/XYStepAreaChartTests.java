...
public class XYStepAreaChartTests extends TestCase {
	...
	public void testCreateChart_NullOrientation() {
		try {
			...
			ChartFactory.createXYStepAreaChart("Step Chart", // chart title
	...
	public void testCreateChart_MinimalOperations() {
		JFreeChart chart = createChart_MinimalOptions();

		assertTrue(chart.getXYPlot() instanceof XYPlot);
	...
	private static JFreeChart createChart() {
		...
		// create the chart...
		return ChartFactory.createXYStepAreaChart("Step Chart", // chart title
