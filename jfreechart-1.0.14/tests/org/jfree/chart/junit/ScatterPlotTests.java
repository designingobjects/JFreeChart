...
public class ScatterPlotTests extends TestCase {
	...
	public void testCreateScatterPlot_NullOrientation() {
		try {
			ChartFactory.createScatterPlot("Scatter Plot", // chart title
	...
	public void testCreateScatterPlot_DisabledTooltipEnabledURL() {
		JFreeChart chart = createChart_DisabledTooltipEnabledURL();

		assertNull(chart.getLegend());
		assertNull(((XYPlot) chart.getPlot()).getRenderer()
				.getBaseToolTipGenerator());
		assertNotNull(((XYPlot) chart.getPlot()).getRenderer()
				.getURLGenerator());
	}
	...
	private static JFreeChart createChart_DisabledTooltipEnabledURL() {
