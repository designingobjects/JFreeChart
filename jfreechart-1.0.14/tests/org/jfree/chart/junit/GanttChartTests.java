...
public class GanttChartTests extends TestCase {
	...
	public void testCreateGnattChart_MinimalOptions() {
		JFreeChart gnatt = ChartFactory.createGanttChart("Gantt Chart",
				"Domain", "Range", null, false, // include legend
				false, false);
		
		assertNull(gnatt.getLegend());
		assertNull(((CategoryPlot) gnatt.getPlot()).getRenderer()
