...
import org.jfree.chart.editor.EditorPackageTests;
import org.jfree.chart.encoders.EncodersPackageTests;
...
import org.jfree.chart.panel.junit.PanelPackageTests;
...
/**
 * A test suite for the JFreeChart class library that can be run using JUnit (
 * <code>http://www.junit.org<code>).
 */
public class JFreeChartTestSuite extends TestCase {
	...
	public static Test suite() {
		...
		suite.addTest(EditorPackageTests.suite());
		suite.addTest(EncodersPackageTests.suite());
		...
		suite.addTest(PanelPackageTests.suite());
