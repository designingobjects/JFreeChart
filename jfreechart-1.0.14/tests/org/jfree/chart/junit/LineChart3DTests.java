...
public class LineChart3DTests extends TestCase {
	...
	public void testCreateLineChart3D_NullOrientation() {
		Number[][] data = new Integer[][] {
		...
		try {
			ChartFactory.createLineChart3D("Line Chart 3D", "Domain", "Range",
	...
	public void testCreateLineChart3D_MinimalOptions() {
		JFreeChart area = createLineChart3D_MinimalOptions();
	...
	private static JFreeChart createLineChart3D_MinimalOptions() {
