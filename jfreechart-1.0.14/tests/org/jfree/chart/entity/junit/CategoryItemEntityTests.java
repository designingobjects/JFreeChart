...
public class CategoryItemEntityTests extends TestCase {
	...
	public void testEquals() {
		...
		e1 = new CategoryItemEntity(new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0),
				"ToolTip", "URL", d, "rowKey", "colKey");
		e2 = new CategoryItemEntity(new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0),
				"ToolTip", "URL", d, "rowKey2", "colKey");
		assertFalse(e1.equals(e2));

		e1 = new CategoryItemEntity(new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0),
				"ToolTip", "URL", d, "rowKey", "colKey");
		e2 = new CategoryItemEntity(new Rectangle2D.Double(1.0, 2.0, 3.0, 4.0),
				"ToolTip", "URL", d, "rowKey", "colKey2");
		assertFalse(e1.equals(e2));
	...
	public void testToString() {
		...
		String expected = "CategoryItemEntity: rowKey=R2, columnKey=C2, dataset=org.jfree.data.category.DefaultCategoryDataset";
		assertTrue(e1.toString().startsWith(expected));
