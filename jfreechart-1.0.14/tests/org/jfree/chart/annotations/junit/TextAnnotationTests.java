...
public class TextAnnotationTests extends TestCase {
	...
	public void testEquals() {
		...
		a1.setPaint(new GradientPaint(1.0f, 2.0f, Color.red, 3.0f, 4.0f,
				Color.pink));
		assertFalse(a1.equals(a2));
		a2.setPaint(new GradientPaint(1.0f, 2.0f, Color.red, 3.0f, 4.0f,
				Color.pink));
		assertTrue(a1.equals(a2));
	...
	public void testConstructor_IllegalArguments() {
		...
		try {
			TextAnnotation a1 = new CategoryTextAnnotation(null, "Category",
					1.0);
			a1.setText(null);
			fail();
		} catch (IllegalArgumentException e) {
	...
	public void testSetter_IllegalArguments() {
		TextAnnotation a1 = new CategoryTextAnnotation("Test", "Category", 1.0);
		try {
			a1.setText(null);
			fail();
