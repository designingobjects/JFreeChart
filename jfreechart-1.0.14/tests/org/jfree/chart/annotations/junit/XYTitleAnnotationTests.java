...
public class XYTitleAnnotationTests extends TestCase {
	...
	public void testEquals() {
		...
		assertFalse(a1.equals(a2));
		a2 = new XYTitleAnnotation(1.1, 2.2, t2);
		a2.setMaxHeight(a1.getMaxHeight());
		assertTrue(a1.equals(a2));
		...
		assertFalse(a1.equals(a2));
		a2 = new XYTitleAnnotation(1.1, 2.2, t2);
		a2.setMaxWidth(a1.getMaxWidth());
		assertTrue(a1.equals(a2));

		a1 = new XYTitleAnnotation(1.1, 2.2, t2, RectangleAnchor.BOTTOM);
		a2 = new XYTitleAnnotation(1.1, 2.2, t2, RectangleAnchor.CENTER);
		assertFalse(a1.equals(a2));
		a2 = new XYTitleAnnotation(1.1, 2.2, t2, a1.getTitleAnchor());
		assertTrue(a1.equals(a2));
	}
	...
	public void testDrawWithNullInfo() {
		...
		try {
			...
			XYTitleAnnotation a = new XYTitleAnnotation(5.0, 6.0,
		...
		try {
			...
			XYPlot plot = new XYPlot(dataset, new NumberAxis("X"),
					new NumberAxis("Y"), new XYLineAndShapeRenderer());
			XYTitleAnnotation xyTitleAnnotation = new XYTitleAnnotation(5.0,
					6.0, new TextTitle("Hello World!"));
	...
	public void testConstructor_IllegalArguments() {
		try {
			new XYTitleAnnotation(1, 1, null, null);
			fail();
		} catch (IllegalArgumentException e) {
		}
		try {
			new XYTitleAnnotation(1, 1, new TextTitle("Title"), null);
			fail();
		} catch (IllegalArgumentException e) {
		}
	}
