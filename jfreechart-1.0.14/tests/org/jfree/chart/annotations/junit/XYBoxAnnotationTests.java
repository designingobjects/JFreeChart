...
public class XYBoxAnnotationTests extends TestCase {
	...
	public void testEquals() {
		...
		GradientPaint gp1a = new GradientPaint(1.0f, 2.0f, Color.blue, 3.0f,
				4.0f, Color.red);
		GradientPaint gp1b = new GradientPaint(1.0f, 2.0f, Color.blue, 3.0f,
				4.0f, Color.red);
		GradientPaint gp2a = new GradientPaint(5.0f, 6.0f, Color.pink, 7.0f,
				8.0f, Color.white);
		GradientPaint gp2b = new GradientPaint(5.0f, 6.0f, Color.pink, 7.0f,
				8.0f, Color.white);
		...
		// y0
		a1 = new XYBoxAnnotation(1.0, 99.0, 3.0, 4.0, new BasicStroke(2.3f),
				gp1a, gp2a);
		assertFalse(a1.equals(a2));
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f),
				gp1b, gp2b);
		...
		// x1
		a1 = new XYBoxAnnotation(1.0, 2.0, 99.0, 4.0, new BasicStroke(2.3f),
				gp1a, gp2a);
		assertFalse(a1.equals(a2));
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f),
				gp1b, gp2b);
		...
		// y1
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 99.0, new BasicStroke(2.3f),
				gp1a, gp2a);
		assertFalse(a1.equals(a2));
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f),
				gp1b, gp2b);
		...
		// stroke
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 4.0, new BasicStroke(4.4f),
				gp1a, gp2a);
		assertFalse(a1.equals(a2));
		a1 = new XYBoxAnnotation(1.0, 2.0, 3.0, 4.0, new BasicStroke(2.3f),
				gp1b, gp2b);
	...
	public void testDrawWithNullStrokeAndOutliningPaint() {
		boolean success = false;
		try {
			DefaultTableXYDataset dataset = new DefaultTableXYDataset();
			...
			plot.addAnnotation(new XYBoxAnnotation(10.0, 12.0, 3.0, 4.0, null,
					null));
			JFreeChart chart = new JFreeChart(plot);
			/* BufferedImage image = */chart
					.createBufferedImage(300, 200, null);
